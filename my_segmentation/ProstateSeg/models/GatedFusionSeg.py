...
class GatedFusionModule(nn.Module):
    def __init__(self, input_channels):
        ...
        self.conv_x = nn.Conv2d(input_channels, input_channels, kernel_size=3, padding=1)
        self.conv_y = nn.Conv2d(input_channels, input_channels, kernel_size=3, padding=1)

        # Gating mechanism
        self.gate = nn.Conv2d(input_channels, 1, kernel_size=1)
